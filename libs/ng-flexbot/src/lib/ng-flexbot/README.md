...
Voici le README mis à jour avec une section finale listant les modèles disponibles pour `ng-flexbot` :
...
export class AppComponent {
  ...
  promptContext = "";
  textModel = FlexbotCurrentTextModel.GOOGLE_GEMINI_PRO;
  imageModel = FlexbotCurrentImageModel.OPEN_AI_DALL_E_3;
  welcomeMessage = "Welcome to Flexbot!";
}
```
